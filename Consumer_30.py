...
consumer = KafkaConsumer('awskafkatopic30',bootstrap_servers=['b-1.mskcsv.******.c4.kafka.eu-north-1.amazonaws.com:9092'],consumer_timeout_ms=10000)
...
try:
cur.execute("SELECT * FROM msksc.cust_dat30")
...
print(city)
print(record)
query = "INSERT INTO msksc.cust_dat30(id, timestamp, longitude,latitude) VALUES (%s,%s, %s, %s);"
